...
export default function Dashboard() {
  ...
  return (
    <div className="h-[calc(100vh-4rem)] overflow-hidden bg-background-light dark:bg-background-dark font-inter">
      {/* Main Dashboard Layout */}
      <div className="grid grid-cols-1 md:grid-cols-3 h-full">
        {/* Column 1 - Add Task */}
        <div className="bg-surface-light h-full dark:bg-background-dark shadow-lg p-6 flex flex-col space-y-4 border-r">
        ...
        <div className="bg-surface-light dark:bg-background-dark shadow-lg p-6 flex flex-col space-y-4 border-r overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200 dark:scrollbar-thumb-gray-600 dark:scrollbar-track-gray-800 h-full">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">
            To-Do Tasks
          </h2>
        ...
        <div className="bg-surface-light dark:bg-background-dark shadow-lg p-6 flex flex-col space-y-6 h-full">
